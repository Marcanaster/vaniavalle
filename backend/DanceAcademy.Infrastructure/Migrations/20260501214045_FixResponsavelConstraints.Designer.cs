...
namespace DanceAcademy.Infrastructure.Migrations
{
    ...
    [Migration("20260501214045_FixResponsavelConstraints")]
    partial class FixResponsavelConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModalidadeTurma", b =>
                {
                    b.Property<Guid>("ModalidadesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("TurmasId")
                        .HasColumnType("uuid");

                    b.HasKey("ModalidadesId", "TurmasId");

                    b.HasIndex("TurmasId");

                    b.ToTable("ModalidadeTurma");
                });
            ...
            modelBuilder.Entity("ModalidadeTurma", b =>
                {
                    b.HasOne("DanceAcademy.Domain.Entities.Modalidade", null)
                        .WithMany()
                        .HasForeignKey("ModalidadesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DanceAcademy.Domain.Entities.Turma", null)
                        .WithMany()
